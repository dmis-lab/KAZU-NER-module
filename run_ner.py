...
class DataTrainingArguments:
    ...
    label_column_name: str = field(
        default=None, metadata={"help": "The column name of label to input in the file REQUIRED! Should be one of labels or label_probs."}
    )
...
def main():
            ...
            for word_idx in word_ids:
                ...
                if data_args.use_probs:
                    if word_idx is None:
                        ...
                        label_prob_outputs.append(label_prob_inp[word_idx] if data_args.label_all_tokens else [0]*data_args.num_labels)
    ...
    data_collator = DataCollatorForProbTokenClassification(tokenizer, pad_to_multiple_of=8 if training_args.fp16 else None)
